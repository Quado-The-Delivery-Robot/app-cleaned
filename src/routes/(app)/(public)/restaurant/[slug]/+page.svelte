        ...
        <div class="text-lg relative">
            <div class="w-full">
                {#each Array(2) as _, index}
                    <div class="w-full h-full {index == 1 ? 'absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-full' : ''}">
                        <div class="flex gap-0.5" style="width: {index == 1 ? (index / 5) * 100 : 100}%;">
