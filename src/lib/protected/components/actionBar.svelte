<div class="onlyGlassSecondary border-r flex justify-center items-center lg:items-start flex-row lg:flex-col lg:h-full w-screen lg:w-[25vw] xl:w-[20vw] lg:px-12 py-3 lg:py-6 leading [&>*]:lg:flex [&>*]:items-center [&>*]:gap-1">
    <a href="/home">
        <svg class="aspect-square h-7 fill-brand-600" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
