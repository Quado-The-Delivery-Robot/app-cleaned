...
<div class="onlyGlassSecondary border-r flex px-6 justify-between lg:justify-center items-center text-left pb-5 lg:pb-0 lg:gap-7 lg:items-start flex-row lg:flex-col lg:h-full w-screen lg:w-[25vw] xl:w-[20vw] lg:px-12 py-3 lg:py-6 leading [&>a]:lg:gap-4 [&>a]:w-auto [&>a]:lg:w-full [&>a]:lg:flex [&>a]:items-center [&>a]:gap-1" bind:this={actionBar}>
    <a href="/home">
