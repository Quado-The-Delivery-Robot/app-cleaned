<div class="onlyGlassSecondary border-r flex justify-center items-center lg:gap-7 lg:items-start flex-row lg:flex-col lg:h-full w-screen lg:w-[25vw] xl:w-[20vw] lg:px-12 py-3 lg:py-6 leading [&>a]:lg:gap-4 [&>a]:lg:flex [&>a]:items-center [&>a]:gap-1">
    <a href="/home">
        ...
        <span class="hidden lg:block lg:text-xl">Home</span>
    </a>
    ...
    <a href="/cart">
        ...
        <span class="hidden lg:block lg:text-xl">Cart</span>
    </a>
    ...
    <div class="px-2 lg:!hidden">
        <div class="h-7 aspect-square relative">
            <button class="border border-backgroundSecondary absolute -translate-y-[calc(50%_+_0.1rem)] left-1/2 -translate-x-1/2 bg-brand-600 rounded-xl rotate-45 p-1" id="quickActionButton">
                ...
                <span class="hidden lg:auto">Create</span>
            </button>
        </div>
    </div>
    ...
    <a href="/orders">
        ...
        <span class="hidden lg:block lg:text-xl">Orders</span>
    </a>
    ...
    <div class="w-full h-[1px] bg-background-600" />

    <button class="border border-backgroundSecondary -translate-x-1/2 bg-brand-600 rounded-xl rotate-45 p-1 lg:hidden">
